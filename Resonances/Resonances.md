>“A Mantra is a Word spoken into the Song. A Resonance is when the Song begins speaking in your voice.”
...
The Song can be understood as an invisible metaphysical structure layered over reality itself. Through Ether, living beings interact with this structure, manipulating portions of it to produce supernatural effects.
...
A Resonance is fundamentally different. A Resonance forms when repeated interaction with the Song causes the Song itself to permanently adapt around a person.

Instead of manually manipulating reality, reality near the user begins behaving differently by default. The individual effectively becomes a fixed point within the Song, a stable distortion that continuously influences nearby “coordinates” of reality.
...
Resonances are not cast. They are passive or semi-passive laws that reality has learned from the user. A Resonance does not function like a spell and cannot usually be replicated through training. It requires far less conscious control and may partially function without Ether expenditure. 

The user no longer fully “commands” the phenomenon. Instead, the Song begins anticipating the user’s intent automatically.

In other words:

| Mantra                  | Resonance                    |
| ----------------------- | ---------------------------- |
| You manipulate the Song | The Song adapts to you       |
| Temporary effect        | Persistent distortion        |
