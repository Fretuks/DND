# Variant II - Iron Vein
**Reagent:** Trace of industrial metals or mining dust
**Effect**:
- Physical AC **+5 (Blunt, Slash, Pierce)**
- Gain **+1 Constitution** for the duration
**Drawback**
...
- Increase Max HP by 5 for the duration
- Necrotic AC **+15**
**Drawback**
- Posture Regain **-1**
- Posture damage taken +50%

The mixture slows blood flow and reduces pain response. The body becomes tougher but sluggish.
# Variant V - Frostbite
**Reagent:** Frost fungus or Frost gland
**Effect**
- Ice AC **+15**
- Max posture **+2**
**Drawback**
...
**Reagent:** Ether crystal
**Effect**:
- Ether Regain **+1**
- Ether Capacity **+5**
**Drawback**:
- Sanity loss from hostile environments increases by **1**
- Willpower -1
...
**Effect**:
- Necrotic AC **+30**
- Regain +2 Health immediately
- Regain 1 Health per round
- Gain **+2 damage against staggered targets**
**Drawback**
...
**Reagent:** Dead biomass
**Effect**:
- Posture **+3**
- Posture Regain **+2**
**Drawback**
- Every round roll a **Constitution check**.  
	- Failure causes **1d4 necrotic damage**.

The heart begins pumping rapidly, flooding muscles with oxygen. The strain causes small internal damage.
# Variant XIII - Super Meridian Crack
**Reagent:** Stabilized Black Meridian crystal
This mixture was never used in the mines. It was developed by smugglers experimenting with concentrated ore.
**Effect**:
- Strength **+2**
- Dexterity **+2**
- Movement Speed **+3 meters**
